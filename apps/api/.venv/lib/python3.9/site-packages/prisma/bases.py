...
class BasePrompt(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Prompt']] = 'Prompt'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.PromptActions[_PrismaModelT]':
        from .client import get_client

        return actions.PromptActions[_PrismaModelT](client or get_client(), cls)
