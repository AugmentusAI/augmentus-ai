...
class PromptActions(Generic[_PrismaModelT]):
    ...
    async def query_first(
        ...
        *args
        ...
        user = await Prompt.prisma().query_first(
            'SELECT * FROM Prompt WHERE userId = $1',
            1149758321,
        )
        ```
        """
    ...
    async def find_many(
        ...
        # find the first 5 Prompt records ordered by the rawPrompt field
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Prompt record ordered by the optimized field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Prompt record ordered by the createdAt field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Prompt records by optimized values
        # and count how many records are in each group
